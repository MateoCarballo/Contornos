...
/**
 * Esta clase comprueba los formatos de los emails. Gracias a metodos contenidos en esta clase podemos
 * asegurar si es email es valido o no.
 */
public final class Validaciones {
    ...
    /**
     *
     * @param email Correo electrico a registrar.
     * @return  Devuelve True si es inválido y False si es correcto y cumple las normas.
     */
